...
The bounds are user defined and can be accurate to 15 decimal points . We get the approximation and also an error margin of 95% confidence which is acceptable for those types of monte carlo approximations 
